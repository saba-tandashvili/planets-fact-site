      ...
      <div className="main">
        <div className="top">
          ...
          <div className="info">
            ...
            <p className="details">
              Neptune is the eighth and farthest-known Solar <br /> planet from the Sun. In the Solar System, it is <br /> the fourth-largest planet by diameter, the <br /> third-most-massive planet, and the densest <br /> giant planet. It is 17 times the mass of Earth, <br /> more massive than its near-twin Uranus.
            </p>
